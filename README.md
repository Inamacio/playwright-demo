...
This use case performs login and a search on the Udemy course site
...
Execute
Create .env from base .env.example, change email and password valid
```
yarn start
```

Execute test. Test example
```
yarn test
```
